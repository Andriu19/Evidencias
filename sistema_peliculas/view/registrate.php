...
<div class="container grey lighten-5" style="padding: 0px 10px;">
    ...
    <h2 class="center">Registrate </h2>
      ...
      <center>
          <br>
          <button class="btn waves-effect waves-light orange darken-4" type="submit" name="action">Registrar
   ...
   <center>
    <a class="btn waves-effect waves-light red darken-4" data-position="bottom" data-tooltip="Iniciar Sesión" href="iniciar_sesion.php">Inicia Sesión</a>
    </center>
    <br>
  </div>
</div>
