...
<?php $page = 'iniciar_sesion'; include("layout/header.php"); ?>
<link rel="stylesheet" href="css/master.css?n=1">
<div id="row" class="row">

	<div class="col s3" imagen_iniciar_sesion"></div>
	<div class="row white">
    <form class="col l6 s8" action="post" id="inicio_de_sesion">
      ...
      <center>
      	  ...
      	  <br>
       <input class="boton_iniciar_sesion" id="azul" type="submit" name="action" value="INICIAR SESION " />
  		</center>
      </div>
  		<br><br>
  		<center>
